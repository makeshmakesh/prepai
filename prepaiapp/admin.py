...
@admin.register(CreditShare)
class CreditShareAdmin(admin.ModelAdmin):
    pass
...
class CourseAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            "OpenAI Integration",
            {"fields": ("assistant_id", "system_prompt"), "classes": ("collapse",)},
        ),
    )
...
class SubtopicAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Structure", {"fields": ("order", "is_optional", "difficulty_rating")}),
        (
            "Content & Syllabus",
            {
                "fields": (
        ...
        ("Settings", {"fields": ("estimated_minutes", "is_active")}),
    )
