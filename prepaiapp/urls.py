...
urlpatterns = [
    ...
    path('course/<slug:slug>/subtopics/', views.CourseSubtopicsView.as_view(), name='course_subtopics'),
path('interview/start/<uuid:template_id>/', views.StartInterviewView.as_view(), name='start_interview'),
    path('interview/session/<uuid:session_id>/', views.InterviewSessionView.as_view(), name='interview_session'),
